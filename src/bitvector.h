...
public:
	...
	bool operator==(const BitVectorIterator<T>& b) const { return byte_ref_ == b.byte_ref_ && bit_id_ == b.bit_id_; };
	bool operator==(const ConstBitVectorIterator<T>& b) const { return byte_ref_ == b.byte_ref_ && bit_id_ == b.bit_id_; };
	bool operator!=(const BitVectorIterator<T>& b) const { return byte_ref_ != b.byte_ref_ || bit_id_ != b.bit_id_; };
	bool operator!=(const ConstBitVectorIterator<T>& b) const { return byte_ref_ != b.byte_ref_ || bit_id_ != b.bit_id_; };
